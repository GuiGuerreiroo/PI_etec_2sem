...
import { IReservationRepository, ReservationFilterOptions, ReservationUpdateOptions } from "../../domain/interface/IReservationRepository";
import { BadRequestException } from "../../helpers/exceptions";
import { ReservationMongoDTO } from "../database/mongo/reservation_repository_mongo";

export class ReservationRepoMock implements IReservationRepository {
    ...
    async getReservationsByFilter(filter: ReservationFilterOptions): Promise<ReservationMongoDTO[] | null> {
        ...
        //     (!filter.userId || reservation.userId === filter.userId) &&
